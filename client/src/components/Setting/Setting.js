...
const Setting = ({ darkModeValue }) => {
    ...
    return (
        ...
        <div class="container">
            ...
            <div class="sidebar">
                <div data-theme={darkModeValue} class="relative">
                    <div class="flex flex-col sm:flex-row sm:justify-around">
                        <div class="h-screen w-72">
                            ...
                            <nav class="mt-10 px-6 ">
                                <a className="py-2 px-4 flex justify-center items-center  btn-primary focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                ...
                                <br />
                                <a className="py-2 px-4 flex justify-center items-center btn-outline btn-primary focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                    <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
